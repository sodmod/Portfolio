...
function AboutMePage() {
  return (
    <section className="relative w-full min-h-[100vh] h-[100vh] max-w-full">
      <div className="flex flex-row h-[inherit] min-h-[100%] wax-w-full">
        <div className="bg-[#216D8F] w-full font-[Arial] not-italic sm:w-3/6 h-[inherit] min-h-[inherit] md:text-xl">
          <div className="w-full h-[inherit] min-h-[inherit] overflow-hidden pt-32">
            <div className="w-[100%] h-[inherit] sm:w-[80%] lg:mx-auto text-white pt-16 pl-2">
